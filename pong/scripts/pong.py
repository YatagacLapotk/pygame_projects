...
halfsideimgs = pygame.image.load("/Users/yatagaclapotk/Desktop/Genel_Calismalar/pygame_projects/pong/images/halfside.png")
halfsidimg = pygame.transform.scale(halfsideimgs,(halfsideimgs.get_width(),HEIGHT))
ballimgs = pygame.image.load("/Users/yatagaclapotk/Desktop/Genel_Calismalar/pygame_projects/pong/images/ball.png")
ballimg = pygame.transform.scale(ballimgs,(BALLSIZE,BALLSIZE))
playerimgs = pygame.image.load("/Users/yatagaclapotk/Desktop/Genel_Calismalar/pygame_projects/pong/images/player.png")
...
class Player:
    ...
    def goal_conceded(self):
        self.goal+=1
        goal_sound = pygame.mixer.Sound("/Users/yatagaclapotk/Desktop/Genel_Calismalar/pygame_projects/pong/sounds/goal.mp3")
        goal_sound.play()
    def won(self):
        if self.goal==10:
            return True
...
def draw_goal(screen:pygame.Surface,player:Player,x,y):
    font = pygame.font.Font("/Users/yatagaclapotk/Desktop/Genel_Calismalar/pygame_projects/pong/pong-score/pong-score.ttf",40)
...
def game(screen:pygame.Surface):
    ...
    while True:
        ...
        if ball.position.y >= HEIGHT or ball.position.y <= 0:
            ball.bounce_walls()
            wall_sound = pygame.mixer.Sound("/Users/yatagaclapotk/Desktop/Genel_Calismalar/pygame_projects/pong/sounds/wall.mp3")
            wall_sound.play()
        if ball_rect.colliderect(player1_rect) or ball_rect.colliderect(player2_rect):
            ball.bounce_player()
            player_sound = pygame.mixer.Sound("/Users/yatagaclapotk/Desktop/Genel_Calismalar/pygame_projects/pong/sounds/player.mp3")
            player_sound.play()
