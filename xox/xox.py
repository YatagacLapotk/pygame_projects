...
def xox():   
    ...
    player_select = 0
    xs = pygame.image.load("/Users/yatagaclapotk/Desktop/Genel_Calismalar/pygame_projects/xox/images/x_image.png").convert()
    x = pygame.transform.scale(xs,[225,225])
    os = pygame.image.load("/Users/yatagaclapotk/Desktop/Genel_Calismalar/pygame_projects/xox/images/o_image.png").convert()
